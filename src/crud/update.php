<?php
    ...
    if(isset($_POST['mod_datos'])){
        ...
        $sql="UPDATE cliente SET id_cliente='$id_cliente', nombre='$nombre', apellido_paterno='$apellido_paterno', apellido_materno='$apellido_materno', edad='$edad', genero='$genero', 
