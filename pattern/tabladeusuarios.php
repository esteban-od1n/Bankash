...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/tabladeusuarios.css">
</head>
<body>
    <header class="header" >
        <img class="logo" src="../img/Logo1.png" alt="">
        <h1 class="titulo">Ver tabla de usuarios registrados</h1>
        ...
        <div class="tabla col-md-5">
             ...
             <tbody>
                ...
                <th> <a href="../src/crud/actualizar.php?php echo $row['id_cliente']?>" class="btn btn-info">Editar</a></th>
